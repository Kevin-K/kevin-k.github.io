...
there was a flashy reason to do this. Pragmaticly, the resume has nothing to gain in performance
or content editability (since its just updating a JSON file). Hobby projects are a great chance for
developers to through pragmatism aside and try new things "just because". 
...
modified layout. **Bad: breaks [single responsiblity principle](https://blog.cleancoder.com/uncle-bob/2014/05/08/SingleReponsibilityPrinciple.html)**
...
Iteration. Extracting code often poses new challenges, so I 
...
### Iteration 3: Sweeping under the Rug
